    ...
    <div class="min-h-screen flex" x-data="{ activeMenu: 'dashboard' }">
        <aside
            ...
            <nav class="flex-1 px-4 space-y-1.5 aside-scroll overflow-y-auto mt-4">
                ...
                <a href="{{ route('nurse.dashboard.index') }}" @click="activeMenu = 'dashboard'"
                ...
                <a href="{{ route('admin.regis.queue.index') }}" @click="activeMenu = 'dokter'"
                    ...
                    <span class="text-sm font-medium">Antrean Patient</span>
                </a>
