...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <nav class="flex text-sm text-gray-400 mb-2">
            ...
            <span class="text-emerald-600 font-medium">Edit Poli</span>
        </nav>
        <h1 class="text-3xl font-bold text-gray-800">Edit Poliklinik</h1>
        <p class="text-gray-500 mt-1">Update spesialisasi layanan medis ke dalam sistem.</p>
    </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-emerald-900/5 border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('update.poli', $poli->id) }}" method="POST" class="p-8 md:p-10">
            @csrf
            @method('PUT')
